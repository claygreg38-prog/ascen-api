    ...
    html: `
      <div style="background:#061a2a;color:white;padding:40px;font-family:Arial,sans-serif;">
        ...
        <p style="color:#f07050;margin-top:20px;font-size:12px;">
          ${legalDisclaimer || 'This report is generated by AI analysis of communication patterns and is intended for therapeutic context only. It is not a clinical assessment and should not be used in legal proceedings.'}
        </p>
      </div>
    `,
    text: `ASCEN Therapy Prep Report for ${familyName}, ${reportPeriod}. See full report in the ASCEN app.`,
